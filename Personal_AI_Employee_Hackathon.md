...
|-----------|-------------|---------|
| Claude Code | Active subscription (Pro or Free Gemini API with Claude Code Router) | Primary reasoning engine |
...
To keep your AI Employee working autonomously until a task is complete, use the Ralph Wiggum pattern: a Stop hook that intercepts Claude's exit and feeds the prompt back.
...
│ PERCEPTION LAYER                                                 │
│ ┌──────────────┐ ┌──────────────┐ ┌──────────────┐              │
│ │ Gmail Watcher│ │WhatsApp Watch│ │Finance Watch│              │
